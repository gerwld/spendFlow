...
const THEMEV = {
  ...
  st_theme__dark: {
    label: "dark",
    headerGradientStart: "#181b1c",
    headerGradientEnd: "#3B404C",

    headerSelectDateSVGColor: "#ffffff",
    headerSelectDateBorderColor: "#5f6576",
    headerSelectDateBackgroundColor: "#454953",
    mainHeaderLabelColor: "#ffffff",
    mainHeaderBackgroundColor: "#434751",
    mainHeaderBorderColor: "#717582",
