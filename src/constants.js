...
const THEMEV = {
  st_theme__light: {
    ...
    headerGradientEnd: "#d6e0ff",
    headerSelectDateSVGColor: "#7884a5",
    headerSelectDateBorderColor: "#c7d3f1",
    headerSelectDateBackgroundColor: "#d5dffb42",
    mainHeaderLabelColor: "#44677a",
    mainHeaderBackgroundColor: "#ffffff",
    mainHeaderBorderColor: "#ffffff",
  ...
  st_theme__dark: {
    label: "dark",
    headerGradientStart: "#131516",
    headerGradientEnd: "#2e323b",

    headerSelectDateSVGColor: "#b1b1b1",
    headerSelectDateBorderColor: "#434855c6",
    headerSelectDateBackgroundColor: "#2d2f37c5",
    mainHeaderLabelColor: "#ffffff",
    mainHeaderBackgroundColor: "#3a3e47",
    mainHeaderBorderColor: "#4d505c",
